...
source_x86_64=("https://github.com/apple/foundationdb/releases/download/${pkgver}/foundationdb-server-${pkgver}-${pkgrel}.el7.x86_64.rpm")
sha256sums_x86_64=('f9b09553901fc4e8536502accd9b2d1eba7594fac46896a43ee08e2bdd773572')
...
package(){
	...
	# install -m 755 -v -D -t "${srcdir}/lib" "${pkgdir}/usr/lib"
	# install -m 755 -v -D -t "${srcdir}/etc" "${pkgdir}/"
	# install -m 755 -v -D -t "${srcdir}/usr" "${pkgdir}/"
}
